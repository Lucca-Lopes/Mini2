...
//        backgroundColor = .systemGray6
        ...
        let mausoleu2 = MausoleuView(posMausoleu: CGPoint(x: 3.25, y: 0.65), nome: "trabalhador", ativo: vm.mausoleus[3], cova1Ativa: vm.covas[6], cova2Ativa: vm.covas[7], dinheiroGanho: 15, tempoCova: 10, precoMausoleu: 100, precoCova: 50)

        let mausoleu3 = MausoleuView(posMausoleu: CGPoint(x: 0.75, y: 0.4), nome: "artista", ativo: vm.mausoleus[1], cova1Ativa: vm.covas[2], cova2Ativa: vm.covas[3], dinheiroGanho: 30, tempoCova: 15, precoMausoleu: 250, precoCova: 125)
        let mausoleu4 = MausoleuView(posMausoleu: CGPoint(x: 3.25, y: 0.4), nome: "empresario", ativo: vm.mausoleus[4], cova1Ativa: vm.covas[8], cova2Ativa: vm.covas[9], dinheiroGanho: 45, tempoCova: 20, precoMausoleu: 600, precoCova: 300)

        let mausoleu5 = MausoleuView(posMausoleu: CGPoint(x: 0.75, y: 0.15), nome: "militar", ativo: vm.mausoleus[2], cova1Ativa: vm.covas[4], cova2Ativa: vm.covas[5], dinheiroGanho: 60, tempoCova: 25, precoMausoleu: 1000, precoCova: 500)
