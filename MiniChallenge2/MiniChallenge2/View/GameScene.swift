...
class GameScene: SKScene{
    ...
    override func didMove(to view: SKView) {
        ...
        let mausoleu2 = MausoleuView(posMausoleu: CGPoint(x: 1, y: 0.45), nome: "artista", ativo: vm.mausoleus[1], cova1Ativa: vm.covas[2], cova2Ativa: vm.covas[3], dinheiroGanho: 30, tempoCova: 15)
        let mausoleu3 = MausoleuView(posMausoleu: CGPoint(x: 1, y: 0.2), nome: "militar", ativo: vm.mausoleus[2], cova1Ativa: vm.covas[4], cova2Ativa: vm.covas[5], dinheiroGanho: 60, tempoCova: 25)
        
        let mausoleu4 = MausoleuView(posMausoleu: CGPoint(x: 3, y: 0.7), nome: "trabalhador", ativo: vm.mausoleus[3], cova1Ativa: vm.covas[6], cova2Ativa: vm.covas[7], dinheiroGanho: 15, tempoCova: 10)
        let mausoleu5 = MausoleuView(posMausoleu: CGPoint(x: 3, y: 0.45), nome: "empresario", ativo: vm.mausoleus[4], cova1Ativa: vm.covas[8], cova2Ativa: vm.covas[9], dinheiroGanho: 45, tempoCova: 20)
        let mausoleu6 = MausoleuView(posMausoleu: CGPoint(x: 3, y: 0.2), nome: "rei", ativo: vm.mausoleus[5], cova1Ativa: vm.covas[10], cova2Ativa: vm.covas[11], dinheiroGanho: 90, tempoCova: 30)
